...
-- ----------------------------
INSERT INTO `bms_comment` VALUES ('1373639669329293314', '这个不会是脑子烧坏了吧', '1372901357303955458', '1373639550894731265', '2021-03-21 22:16:33', null);
...
CREATE TABLE `bms_follow` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='用户关注';
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='话题-标签 中间表';
...
INSERT INTO `bms_post_tag` VALUES ('52', '1373639551184138241', '1373639550894731265');
...
INSERT INTO `bms_tag` VALUES ('1373639551184138241', '无聊啊', '1');
...
-- Records of ums_user
-- ----------------------------
INSERT INTO `ums_user` VALUES ('1349290158897311745', 'admin', 'admin', '$2a$10$8qx711TBg/2hxfL7N.sxf.0ROMhR/iuPhQx33IFqGd7PLgt5nGJTO', 'https://s3.ax1x.com/2020/12/01/DfHNo4.jpg', '23456@qq.com', null, '2', '', '自由职业者', '', '', null, '2021-01-13 17:40:17', null);
INSERT INTO `ums_user` VALUES ('1349618748226658305', 'zhangsan', 'zhangsan', '$2a$10$7K3yYv8sMV5Xsc2facXTcuyDo8JQ4FJHvjZ7qtWYcJdei3Q6Fvqdm', 'https://s3.ax1x.com/2020/12/01/DfHNo4.jpg', '23456@qq.com', null, '0', '', '自由职业者', '', '', null, '2021-01-14 15:25:59', null);
INSERT INTO `ums_user` VALUES ('1372901357303955458', 'cs1', '你爹', 'e10adc3949ba59abbe56e057f20f883e', 'https://s3.ax1x.com/2020/12/01/DfHNo4.jpg', 'cs1@qq.com', null, '1', '', '鬼畜自由职业者', '', '', null, '2021-03-19 21:22:46', null);
